...
Mean of total number of steps is **`r mean_total_steps_per_day`**  
Median of total number of steps is **`r median_total_steps_per_day`**
...
The 5-minute interval that contains the maximum number of steps (on average across all the days in the dataset) is **`r max_steps_interval`**
...
```
The total number of missing values in the raw data set is **`r missing_values`**
...
imputed_median_total_steps_per_day <-
  format(
    median(imputed_steps_per_day$totalsteps),
      ...
      scientific = FALSE)
```
Mean of total number of steps is **`r imputed_mean_total_steps_per_day`**  
Median of total number of steps is **`r imputed_median_total_steps_per_day`**

The following table compares the non-imputed mean and median values with the imputed mean and media values:

| | Non-imputed | Imputed |
|--|-----------|--------------|
|Mean| `r mean_total_steps_per_day` | `r imputed_mean_total_steps_per_day` |
|Median | `r median_total_steps_per_day` | `r imputed_median_total_steps_per_day`  |
